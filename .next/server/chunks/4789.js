"use strict";exports.id=4789,exports.ids=[4789],exports.modules={36119:(e,t,o)=>{o.d(t,{Ui:()=>d,ci:()=>l,mm:()=>s,zk:()=>a});var i=o(55245);let r={user:process.env.EMAIL_USER,clientId:process.env.OAUTH_CLIENT_ID,clientSecret:process.env.OAUTH_CLIENT_SECRET,refreshToken:process.env.OAUTH_REFRESH_TOKEN};function n(){return i.createTransport({service:"gmail",auth:{type:"OAuth2",user:r.user,clientId:r.clientId,clientSecret:r.clientSecret,refreshToken:r.refreshToken}})}async function a(e,t){try{let o=n(),i={from:`${process.env.EMAIL_FROM_NAME} <${process.env.EMAIL_FROM}>`,to:e,replyTo:process.env.EMAIL_REPLY_TO,subject:"Email Verification - Cosmopolitan University",html:`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
                  ...
                  <tr>
                    <td style="padding: 30px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
                      ...
                      <p style="margin: 15px 0 0 0; color: #9ca3af; font-size: 12px;">
                        \xa9 ${new Date().getFullYear()} Cosmopolitan University Abuja. All rights reserved.
                      </p>
                    </td>
                  </tr>
...
\xa9 ${new Date().getFullYear()} Cosmopolitan University Abuja. All rights reserved.
      `},r=await o.sendMail(i);return console.log("Verification email sent:",r.messageId),{success:!0}}catch(e){return console.error("Error sending verification email:",e),{success:!1,error:e instanceof Error?e.message:"Failed to send email"}}}async function s(e,t,o,i,r){try{let a=n(),s={from:`${process.env.EMAIL_FROM_NAME} <${process.env.EMAIL_FROM}>`,to:e,replyTo:process.env.EMAIL_REPLY_TO,subject:"Application Received - Cosmopolitan University",html:`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                        Thank you for submitting your application to Cosmopolitan University! We have successfully received your application for the <strong>${o}</strong> programme.
                      </p>
                          ...
                          <td style="padding: 25px; background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px;">
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                              <tr>
                                ...
                                <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: bold;">${o}</td>
                              </tr>
                              <tr>
                                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Session:</td>
                                <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: bold;">${i}</td>
                              </tr>
                              <tr>
                                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Transaction Ref:</td>
                                <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: bold;">${r}</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      ...
                      <div style="margin: 30px 0; padding: 25px; background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 8px; border: 1px solid #16a34a;">
                        ...
                        <ol style="margin: 0; padding-left: 20px; color: #4b5563; font-size: 15px; line-height: 1.8;">
                          ...
                          <li>Keep this transaction reference for your records: <strong>${r}</strong></li>
                        </ol>
                      </div>
...
Thank you for submitting your application to Cosmopolitan University! We have successfully received your application for the ${o} programme.
...
3. Keep this transaction reference for your records: ${r}

If you have any questions, contact us at ${process.env.EMAIL_REPLY_TO}

Best regards,
Cosmopolitan University Abuja
      `},l=await a.sendMail(s);return console.log("Application confirmation email sent:",l.messageId),{success:!0}}catch(e){return console.error("Error sending application confirmation email:",e),{success:!1,error:e instanceof Error?e.message:"Failed to send email"}}}async function l(e,t,o,i,r){try{let a=await n(),s={from:`"${process.env.EMAIL_FROM_NAME}" <${process.env.EMAIL_FROM}>`,to:e,replyTo:process.env.EMAIL_REPLY_TO,subject:"Payment Successful - Cosmopolitan University Abuja",html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <div style="padding: 40px 30px;">
      ...
      <p style="font-size: 16px; line-height: 1.6; color: #333333;">
        Congratulations! Your payment has been successfully processed and your registration for <strong>${o}</strong> is now confirmed.
      </p>
      ...
      <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 30px 0;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            ...
            <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: 500; text-align: right;">${o}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Amount Paid:</td>
            <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: 500; text-align: right;">₦${i.toLocaleString("en-NG",{minimumFractionDigits:2,maximumFractionDigits:2})}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Transaction Ref:</td>
            <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: 500; text-align: right;">${r}</td>
          </tr>
          <tr>
...
Congratulations! Your payment has been successfully processed and your registration for ${o} is now confirmed.

PAYMENT DETAILS:
Programme: ${o}
Amount Paid: ₦${i.toLocaleString("en-NG",{minimumFractionDigits:2,maximumFractionDigits:2})}
Transaction Reference: ${r}
Status: Successful
...
Best regards,
Cosmopolitan University Abuja
      `},l=await a.sendMail(s);return console.log("Payment success email sent:",l.messageId),{success:!0}}catch(e){return console.error("Error sending payment success email:",e),{success:!1,error:e instanceof Error?e.message:"Failed to send email"}}}async function d(e,t,o,i,r,a){try{let s=await n(),l={from:`"${process.env.EMAIL_FROM_NAME}" <${process.env.EMAIL_FROM}>`,to:e,replyTo:process.env.EMAIL_REPLY_TO,subject:"Payment Failed - Cosmopolitan University Abuja",html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <div style="padding: 40px 30px;">
      ...
      <p style="font-size: 16px; line-height: 1.6; color: #333333;">
        Unfortunately, your payment for <strong>${o}</strong> could not be processed successfully.
      </p>
      ...
      <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 20px; margin: 30px 0;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 8px 0; color: #991b1b; font-size: 14px; font-weight: 500; text-align: right;">${a}</td>
          </tr>
          `:""}
        </table>
      </div>
...
Unfortunately, your payment for ${o} could not be processed successfully.

TRANSACTION DETAILS:
Programme: ${o}
Amount: ₦${i.toLocaleString("en-NG",{minimumFractionDigits:2,maximumFractionDigits:2})}
Transaction Reference: ${r}
Status: Failed
${a?`Reason: ${a}`:""}
...
Best regards,
Cosmopolitan University Abuja
      `},d=await s.sendMail(l);return console.log("Payment failed email sent:",d.messageId),{success:!0}}catch(e){return console.error("Error sending payment failed email:",e),{success:!1,error:e instanceof Error?e.message:"Failed to send email"}}}},72331:(e,t,o)=>{o.d(t,{_:()=>r});var i=o(53524);let r=globalThis.prisma??new i.PrismaClient({log:["query","error","warn"],datasources:{db:{url:"file:./prisma/dev.db"}}})}};