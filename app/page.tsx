...
import { Leaf, Award, BookOpen, Users, Heart, TrendingUp, GraduationCap, Clock } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <AnimatedSection delay={0.2}>
              <AnimatedCounter
                ...
                icon={<Award className="w-8 h-8 text-primary-700" />}
              />
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              <AnimatedCounter
                ...
                icon={<GraduationCap className="w-8 h-8 text-primary-700" />}
              />
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <AnimatedCounter
                ...
                icon={<Heart className="w-8 h-8 text-primary-700" />}
              />
            </AnimatedSection>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <AnimatedSection direction="left" delay={0.2}>
                  <div className="card p-0 hover-scale overflow-hidden">
                    <div className="relative h-64">
                      <Image
                        src="/man-enjoying-indoor-farming.jpg"
                        alt="Herbal Medicine Expert"
                        fill
                ...
                <AnimatedSection direction="right" delay={0.3}>
                  <div className="card p-0 hover-scale overflow-hidden">
                    <div className="relative h-64">
                      <Image
                        src="/man-taking-care-plants-medium-shot.jpg"
                        alt="Herbal Research"
                        fill
                        className="object-cover"
                      />
        ...
        <section className="py-16 bg-gradient-to-br from-green-50 to-primary-50 leaf-bg">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
                  ...
                  <div className="bg-white rounded-xl p-8 shadow-lg hover-scale flex flex-col h-full">
                    ...
                    <ul className="space-y-4 text-gray-700 flex-grow">
                      <li className="flex items-start">
                        ...
                        <span><strong>Natural Healing:</strong> Harnesses the body&apos;s innate healing capabilities</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Fewer Side Effects:</strong> Gentler on the body</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Holistic Approach:</strong> Treats the whole person</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Preventive Care:</strong> Maintains overall wellness</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Complementary Treatment:</strong> Works alongside conventional medicine</span>
                      </li>
                    </ul>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection direction="up" delay={0.3}>
                  <div className="bg-white rounded-xl p-8 shadow-lg hover-scale flex flex-col h-full">
                    ...
                    <ul className="space-y-4 text-gray-700 flex-grow">
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>WHO Recognition:</strong> Vital role in healthcare</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Accessibility:</strong> Affordable for all communities</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Sustainability:</strong> Environmentally friendly</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Cultural Preservation:</strong> Maintains traditional knowledge</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 font-bold mr-2">•</span>
                        <span><strong>Economic Impact:</strong> Supports local communities</span>
                      </li>
                    </ul>
                  </div>
                </AnimatedSection>
              ...
              <AnimatedSection delay={0.4}>
                <motion.div
                  className="mt-10 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl p-8 text-center"
                ...
                <AnimatedSection direction="left" delay={0.2}>
                  <div className="card p-8 hover-scale">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      sophisticated systems of herbal healing.
                    </p>
                    <p className="text-gray-700">
                      In Africa, traditional healers have served as the backbone of healthcare for millennia,
                      passing down invaluable knowledge through oral traditions.
                    </p>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection direction="right" delay={0.3}>
                  <div className="card p-8 hover-scale">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      healers have developed deep understanding of these plants&apos; therapeutic properties.
                    </p>
                ...
                <AnimatedSection direction="up" delay={0.4}>
                  <div className="card p-8 hover-scale">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      practices. Many pharmaceutical drugs are derived from plants.
                    </p>
                    <p className="text-gray-700">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    href="/programmes"
                    className="w-full sm:w-auto bg-white text-primary-700 hover:bg-primary-50 font-bold py-4 px-10 rounded-lg transition-all duration-300 shadow-2xl hover:shadow-white/30 inline-block text-lg"
                  >
                    View All Programmes
                  </Link>
                </motion.div>
